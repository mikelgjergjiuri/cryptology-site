...
// END GENERATED CODE
	...
	Point [] row11Point,row01Point;
	Point [] row12Point,row02Point;
	Point [] row13Point,row03Point;	
	...
	char [] resetrow11data=	{'e','k','m','f','l','g','d','q','v','z','n','t','o','w','y','h','x','u','s','p','a','i','b','r','c','j'};
	char [] resetrow12data=	{'a','j','d','k','s','i','r','u','x','b','l','h','w','t','m','c','q','g','z','n','p','y','f','v','o','e'};
	char [] resetrow13data=	{'b','d','f','h','j','l','c','p','r','t','x','v','z','n','y','e','i','w','g','a','k','m','u','s','q','o'};

	char [] row01data=  {'a','a','a','a','a','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z'};	
	char [] row02data=  {'a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z'};
	char [] row03data=  {'a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z'};
	char [] row11data=	{'e','k','m','f','l','g','d','q','v','z','n','t','o','w','y','h','x','u','s','p','a','i','b','r','c','j'};
	char [] row12data=	{'a','j','d','k','s','i','r','u','x','b','l','h','w','t','m','c','q','g','z','n','p','y','f','v','o','e'};
	char [] row13data=	{'b','d','f','h','j','l','c','p','r','t','x','v','z','n','y','e','i','w','g','a','k','m','u','s','q','o'};
...
// END GENERATED CODE
	...
	for (int i=0;i<26;i++)
		...
		row11Labels[i].setLocation(new java.awt.Point(5, 5+i*20));
		row11Labels[i].setOpaque(false);
		row11Labels[i].setSize(new java.awt.Dimension(40, 20));
		row11Labels[i].setText(row1chars[i]);
		...
		row01Labels[i].setLocation(new java.awt.Point(65, 5+i*20));
		row01Labels[i].setOpaque(false);
		row01Labels[i].setSize(new java.awt.Dimension(40, 20));
		row01Labels[i].setText(chars[i]);
		...
		row12Labels[i].setLocation(new java.awt.Point(5, 5+i*20));
		row12Labels[i].setOpaque(false);
		row12Labels[i].setSize(new java.awt.Dimension(40, 20));
		row12Labels[i].setText(row2chars[i]);
		...
		row02Labels[i].setLocation(new java.awt.Point(65, 5+i*20));
		row02Labels[i].setOpaque(false);
		row02Labels[i].setSize(new java.awt.Dimension(40, 20));
		row02Labels[i].setText(chars[i]);
		...
		row13Labels[i].setLocation(new java.awt.Point(5, 5+i*20));
		row13Labels[i].setOpaque(false);
		row13Labels[i].setSize(new java.awt.Dimension(40, 20));
		row13Labels[i].setText(row3chars[i]);
		...
		row03Labels[i].setLocation(new java.awt.Point(65, 5+i*20));
		row03Labels[i].setOpaque(false);
		row03Labels[i].setSize(new java.awt.Dimension(40, 20));
		row03Labels[i].setText(chars[i]);
		...
		row11Labeltemp.setLocation(new java.awt.Point(5, 525));		
		...
		row01Labeltemp.setLocation(new java.awt.Point(65, 525));		
		...
		row12Labeltemp.setLocation(new java.awt.Point(5, 525));		
		...
		row02Labeltemp.setLocation(new java.awt.Point(65, 525));		
		...
		row13Labeltemp.setLocation(new java.awt.Point(5, 525));		
		row13Labeltemp.setOpaque(false);
		...
		row03Labeltemp.setLocation(new java.awt.Point(65, 525));		
		row03Labeltemp.setOpaque(true);
	...
	//jTextPane1 = createTextPane(jTextPane1,count_chars-1,workingString);
		...
		if(count_chars !=1)
		{
			for (int i=1;i<26;i++)
				{
					temprow0[i-1] = row13data[i];
					temprow1[i-1] = row03data[i];
				}	
			temprow0[25] = row13data[0];
			temprow1[25] = row03data[0];		

			for (int i=0;i<26;i++)
				{
					row13data[i] = temprow0[i];
					row03data[i] = temprow1[i];				
				}	
			...
			if (((count_chars-1) % 26)== 0)
				{
					for (int i=1;i<26;i++)
					{
						temprow0[i-1] = row12data[i];
						temprow1[i-1] = row02data[i];
					}	
					temprow0[25] = row12data[0];
					temprow1[25] = row02data[0];		

					for (int i=0;i<26;i++)
					{
						row12data[i] = temprow0[i];
						row02data[i] = temprow1[i];				
					}	
				}
		...
		for (int i =0; i<26;i++)
			{
				if( row02data[letterpositionInwards12]== row12data[i])
					{
		...
		for (int i =0; i<26;i++)
			{
				if( row01data[letterpositionInwards11]== row11data[i])
					{
		...
		for (int i =0; i<26;i++)
			{
				if( row11data[letterpositionOutwards01]== row01data[i])
					{
		...
		for (int i =0; i<26;i++)
			{
				if( row12data[letterpositionOutwards02]== row02data[i])
					{
		...
		for (int i =0; i<26;i++)
			{
				if( row13data[letterpositionOutwards03]== row03data[i])
					{
		...
		row13Labels[preletterpositionInwards03].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(110, 110, 110)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
		row13Labels[preletterpositionInwards03].setForeground(java.awt.Color.darkGray);
		row12Labels[preletterpositionInwards02].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(110, 110, 110)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
		row12Labels[preletterpositionInwards02].setForeground(java.awt.Color.darkGray);
		row11Labels[preletterpositionInwards01].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(110, 110, 110)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
		row11Labels[preletterpositionInwards01].setForeground(java.awt.Color.darkGray);
		row13Labels[preletterpositionOutwards03].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(110, 110, 110)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
		row13Labels[preletterpositionOutwards03].setForeground(java.awt.Color.darkGray);
		row12Labels[preletterpositionOutwards02].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(110, 110, 110)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
		row12Labels[preletterpositionOutwards02].setForeground(java.awt.Color.darkGray);
		row11Labels[preletterpositionOutwards01].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(110, 110, 110)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
		row11Labels[preletterpositionOutwards01].setForeground(java.awt.Color.darkGray);
		
		row03Labels[preletterpositionInwards13].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(110, 110, 110)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
		row03Labels[preletterpositionInwards13].setForeground(java.awt.Color.darkGray);
		row02Labels[preletterpositionInwards12].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(110, 110, 110)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
		row02Labels[preletterpositionInwards12].setForeground(java.awt.Color.darkGray);
		row01Labels[preletterpositionInwards11].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(110, 110, 110)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
		row01Labels[preletterpositionInwards11].setForeground(java.awt.Color.darkGray);
		row03Labels[preletterpositionOutwards13].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(110, 110, 110)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
		row03Labels[preletterpositionOutwards13].setForeground(java.awt.Color.darkGray);
		row02Labels[preletterpositionOutwards12].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(110, 110, 110)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
		row02Labels[preletterpositionOutwards12].setForeground(java.awt.Color.darkGray);
		row01Labels[preletterpositionOutwards11].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(110, 110, 110)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
		row01Labels[preletterpositionOutwards11].setForeground(java.awt.Color.darkGray);
		//repaint();
		...
		for(int j =0; j<20;j++)
			{
			tempPoint0 =row13Labeltemp.getLocation();
			tempPoint1 =row03Labeltemp.getLocation();
			
			tempPoint0.y= tempPoint0.y-1;
			tempPoint1.y= tempPoint1.y-1;
			row13Labeltemp.setLocation(tempPoint0.x,tempPoint0.y);
			row03Labeltemp.setLocation(tempPoint1.x,tempPoint1.y);
			for (int i=0;i<26;i++)
				{
		...
		for (int i=1;i<26;i++)
			{
				rowTempLabels0[i-1] = row13Labels[i];
				rowTempLabels1[i-1] = row03Labels[i];
			}	
		rowTempLabels0[25] = row13Labels[0];
		rowTempLabels1[25] = row03Labels[0];

		for (int i=0;i<26;i++)
			{
			row13Labels[i] = rowTempLabels0[i];
			row03Labels[i] = rowTempLabels1[i];
			}
		row13Labeltemp.setVisible(false);
		row03Labeltemp.setVisible(false);		
	
			row13Labeltemp.setLocation(5,525);
			row03Labeltemp.setLocation(65,525);			
			row13Labeltemp.setVisible(false);
			row03Labeltemp.setVisible(false);			
	
		
		row13Labels[25].setLocation(5,505);
		row03Labels[25].setLocation(65,505);
	...
	//	dorepaint();
		...
		for(int j =0; j<20;j++)
			{
			tempPoint0 =row12Labeltemp.getLocation();
			tempPoint1 =row02Labeltemp.getLocation();
			
			tempPoint0.y= tempPoint0.y-1;
			tempPoint1.y= tempPoint1.y-1;
			row12Labeltemp.setLocation(tempPoint0.x,tempPoint0.y);
			row02Labeltemp.setLocation(tempPoint1.x,tempPoint1.y);
			for (int i=0;i<26;i++)
				{
		...
		for (int i=1;i<26;i++)
			{
				rowTempLabels0[i-1] = row12Labels[i];
				rowTempLabels1[i-1] = row02Labels[i];
			}	
		rowTempLabels0[25] = row12Labels[0];
		rowTempLabels1[25] = row02Labels[0];

		for (int i=0;i<26;i++)
			{
			row12Labels[i] = rowTempLabels0[i];
			row02Labels[i] = rowTempLabels1[i];
			}
		row12Labeltemp.setVisible(false);
		row02Labeltemp.setVisible(false);		
	
			row12Labeltemp.setLocation(5,525);
			row02Labeltemp.setLocation(65,525);			
			row12Labeltemp.setVisible(false);
			row02Labeltemp.setVisible(false);			
	
	
		row12Labels[25].setLocation(5,505);
		row02Labels[25].setLocation(65,505);
		String fornow = "";
	//	dorepaint();
	...
	//	dorepaint();
		...
		dorepaint(26,26,26,26,26,26,0,0,0,0,0,0);
			plainText = plainText+row13data[letterpositionInwards13];
		...
		row03Labels[letterpositionInwards13].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, java.awt.Color.red)));
		row03Labels[letterpositionInwards13].setForeground(java.awt.Color.red);
		//dorepaint();
		dorepaint(26,26,26,26,26,26,1,0,0,0,0,0);
		try {Thread.sleep(speed*40);}catch (InterruptedException ee){}
		row13Labels[letterpositionInwards03].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, java.awt.Color.red)));
		row13Labels[letterpositionInwards03].setForeground(java.awt.Color.red);
		//dorepaint();
		dorepaint(letterpositionInwards03,26,26,26,26,26,1,0,0,0,0,0);
		try {Thread.sleep(speed*40);}catch (InterruptedException ee){}

		row02Labels[letterpositionInwards12].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, java.awt.Color.red)));
		row02Labels[letterpositionInwards12].setForeground(java.awt.Color.red);
		//dorepaint();
		dorepaint(letterpositionInwards03,26,26,26,26,26,1,1,0,0,0,0);
		try {Thread.sleep(speed*40);}catch (InterruptedException ee){}
		row12Labels[letterpositionInwards02].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, java.awt.Color.red)));
		row12Labels[letterpositionInwards02].setForeground(java.awt.Color.red);
		//dorepaint();
		dorepaint(letterpositionInwards03,letterpositionInwards02,26,26,26,26,1,1,0,0,0,0);
		try {Thread.sleep(speed*40);}catch (InterruptedException ee){}
		
		row01Labels[letterpositionInwards11].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, java.awt.Color.red)));
		row01Labels[letterpositionInwards11].setForeground(java.awt.Color.red);
		//dorepaint();
		dorepaint(letterpositionInwards03,letterpositionInwards02,26,26,26,26,1,1,1,0,0,0);
		try {Thread.sleep(speed*40);}catch (InterruptedException ee){}
		row11Labels[letterpositionInwards01].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, java.awt.Color.red)));
		row11Labels[letterpositionInwards01].setForeground(java.awt.Color.red);
		//dorepaint();
		...
		try {Thread.sleep(speed*40);}catch (InterruptedException ee){}
		row01Labels[letterpositionOutwards11].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, java.awt.Color.blue)));
		row01Labels[letterpositionOutwards11].setForeground(java.awt.Color.blue);
		//dorepaint();
		...
		row12Labels[letterpositionOutwards02].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, java.awt.Color.blue)));
		row12Labels[letterpositionOutwards02].setForeground(java.awt.Color.blue);
		...
		try {Thread.sleep(speed*40);}catch (InterruptedException ee){}
		row02Labels[letterpositionOutwards12].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, java.awt.Color.blue)));
		row02Labels[letterpositionOutwards12].setForeground(java.awt.Color.blue);
//dorepaint();
		...
		row13Labels[letterpositionOutwards03].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, java.awt.Color.blue)));
		row13Labels[letterpositionOutwards03].setForeground(java.awt.Color.blue);
		...
		try {Thread.sleep(speed*40);}catch (InterruptedException ee){}
		row03Labels[letterpositionOutwards13].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, java.awt.Color.blue)));
		row03Labels[letterpositionOutwards13].setForeground(java.awt.Color.blue);
		//repaint();
		try {Thread.sleep(speed*40);}catch (InterruptedException ee){}
		
				
		encryptText = encryptText + row03data[letterpositionOutwards13];
		if(workingwithstrings==0)
	...
	public void reset()
	{
		...
		if (count_chars!=1)
		{
			...
			row13Labels[letterpositionInwards03].setForeground(java.awt.Color.darkGray);
			row12Labels[letterpositionInwards02].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(100, 100, 100)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
			row12Labels[letterpositionInwards02].setForeground(java.awt.Color.darkGray);
			row11Labels[letterpositionInwards01].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(100, 100, 100)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
			row11Labels[letterpositionInwards01].setForeground(java.awt.Color.darkGray);
			row13Labels[letterpositionOutwards03].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(100, 100, 100)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
			row13Labels[letterpositionOutwards03].setForeground(java.awt.Color.darkGray);
			row12Labels[letterpositionOutwards02].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(100, 100, 100)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
			row12Labels[letterpositionOutwards02].setForeground(java.awt.Color.darkGray);
			row11Labels[letterpositionOutwards01].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(100, 100, 100)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
			row11Labels[letterpositionOutwards01].setForeground(java.awt.Color.darkGray);
		
			row03Labels[letterpositionInwards13].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(100, 100, 100)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
			row03Labels[letterpositionInwards13].setForeground(java.awt.Color.darkGray);
			row02Labels[letterpositionInwards12].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(100, 100, 100)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
			row02Labels[letterpositionInwards12].setForeground(java.awt.Color.darkGray);
			row01Labels[letterpositionInwards11].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(100, 100, 100)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
			row01Labels[letterpositionInwards11].setForeground(java.awt.Color.darkGray);
			row03Labels[letterpositionOutwards13].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(100, 100, 100)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
			row03Labels[letterpositionOutwards13].setForeground(java.awt.Color.darkGray);
			row02Labels[letterpositionOutwards12].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(100, 100, 100)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
			row02Labels[letterpositionOutwards12].setForeground(java.awt.Color.darkGray);
			row01Labels[letterpositionOutwards11].setBorder(new javax.swing.plaf.BorderUIResource.CompoundBorderUIResource(new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(100, 100, 100)), new javax.swing.plaf.BorderUIResource.EtchedBorderUIResource(1, java.awt.Color.white, new java.awt.Color(178, 178, 178))));
			row01Labels[letterpositionOutwards11].setForeground(java.awt.Color.darkGray);
		}
	
	count_chars = 1;
	for (int i=0;i<26;i++)
		{
				row11Labels[i].setText(chars[(comboselected1+i) % 26]);
				row12Labels[i].setText(chars[(comboselected2+i) % 26]);
				row13Labels[i].setText(chars[(comboselected3+i) % 26]);
				row01Labels[i].setText(row1chars[(comboselected1+i) % 26]);
				row02Labels[i].setText(row2chars[(comboselected2+i) % 26]);
				row03Labels[i].setText(row3chars[(comboselected3+i) % 26]);
				row01data[i] =  resetRowValues[(comboselected1+i) % 26];
				row02data[i] =  resetRowValues[(comboselected2+i) % 26];
				row03data[i] =  resetRowValues[(comboselected3+i) % 26];
				row11data[i] =  resetrow11data[(comboselected1+i) % 26];
				row12data[i] =  resetrow12data[(comboselected2+i) % 26];
				row13data[i] =  resetrow13data[(comboselected3+i) % 26];
		}
