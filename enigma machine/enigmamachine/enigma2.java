...
// END GENERATED CODE
	...
	char [] row01data=  {'a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z'};	
...
// END GENERATED CODE
	...
	//jTextPane1 = createTextPane(jTextPane1,count_chars-1,workingString);
		...
		for(int j =0; j<20;j++)
			...
			for (int i=0;i<26;i++)
				{
				row13Point[i] =row03Labels[i].getLocation();
				row03Point[i] =row13Labels[i].getLocation();
				row13Point[i].y= row13Point[i].y-1;
				row03Point[i].y= row03Point[i].y-1;				
				row03Labels[i].setLocation(row13Point[i].x,row13Point[i].y);
				row13Labels[i].setLocation(row03Point[i].x,row03Point[i].y);
				}
	...
	//	dorepaint();
		...
		for(int j =0; j<20;j++)
			...
			for (int i=0;i<26;i++)
				{
				row12Point[i] =row02Labels[i].getLocation();
				row02Point[i] =row12Labels[i].getLocation();
				row12Point[i].y= row12Point[i].y-1;
				row02Point[i].y= row02Point[i].y-1;				
				row02Labels[i].setLocation(row12Point[i].x,row12Point[i].y);
				row12Labels[i].setLocation(row02Point[i].x,row02Point[i].y);
				}
